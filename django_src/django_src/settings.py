...
SECRET_KEY = 'django-insecure-&7f_=42(b3cq@s*y0(zotak+2azh2!7+js9t5dcr!phan@5l%f'
...
DRF_FIREBASE_AUTH = {
    ...
    'FIREBASE_SERVICE_ACCOUNT_KEY':
        os.getenv('FIREBASE_SERVICE_ACCOUNT_KEY', 'django_src/Firebase_account_key.json'),
}